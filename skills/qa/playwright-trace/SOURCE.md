...
- Refresh:
  ...
  rsync -a --delete --exclude .git $S/playwright/packages/playwright-core/src/tools/skills/playwright-trace/ $P/skills/qa/playwright-trace/
  cp $S/playwright/LICENSE $P/skills/qa/playwright-trace/LICENSE
