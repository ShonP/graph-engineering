...
- Subtree: plugins/ai/skills/building-pydantic-ai-agents
...
- Refresh:
  ...
  cd $S/skills && git sparse-checkout init --cone && git sparse-checkout set plugins/ai/skills/building-pydantic-ai-agents
  git checkout 9e9390ee24d44b32cf5379c58acaebd7563f5f86
  rsync -a --delete --exclude .git $S/skills/plugins/ai/skills/building-pydantic-ai-agents/ $P/skills/python/building-pydantic-ai-agents/
  cp $S/skills/LICENSE $P/skills/python/building-pydantic-ai-agents/LICENSE
