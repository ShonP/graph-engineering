...
- Refresh:
  ...
  rsync -a --delete --exclude .git $S/grafana-skills/skills/grafana-lgtm/loki/ $P/skills/observability/loki/
  cp $S/grafana-skills/LICENSE $P/skills/observability/loki/LICENSE
