...
- Subtree: skills/grafana-core/promql
...
- Refresh:
  ...
  cd $S/grafana-skills && git sparse-checkout init --cone && git sparse-checkout set skills/grafana-core/promql
  git checkout 51d33e71e191b409bbd25fc7be2684c610d18166
  rsync -a --delete --exclude .git $S/grafana-skills/skills/grafana-core/promql/ $P/skills/observability/promql/
  cp $S/grafana-skills/LICENSE $P/skills/observability/promql/LICENSE
