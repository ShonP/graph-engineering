...
| **UI** | component + one e2e for the journey | - | - | - | client error tracking on the new path | before/after evidence (`ux-evidence`) | behind a flag *if* risky or partial |
